'/=========================================================\`
' Minesweeper for DOS |       { QuickBASIC 4.5 : "QB /L"  } `
'---------------------/                                     `
' (C) David Joffe (1993)       http://www.scorpioncity.com/ `
'                                                           `
...
'  A PDS 7.1 version should be available at the webpage.    '
'-----------------------------------------------------------'
...
QuitLoop:
	...
	IF (x >= 256 AND x <= 290 AND y >= 94 AND y <= 102 AND m.bx <> 0) OR (a$ = "Y") THEN
		...
		PRINT "€                                                                              €"
		PRINT "€     "; : COLOR 1, 0: PRINT "≤≤±±∞∞"; : COLOR 14, 0: PRINT "    David Joffe,        "; : COLOR 1: PRINT "∞∞±±≤≤"; : COLOR 15, 1: PRINT "        http://www.scorpioncity.com/ €"
		PRINT "€     "; : COLOR 1, 0: PRINT "≤≤±±∞∞"; : COLOR 14, 0: PRINT "    DJ Software,        "; : COLOR 1: PRINT "∞∞±±≤≤"; : COLOR 15, 1: PRINT "                                     €"
